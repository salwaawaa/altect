...
class KebakaranDatabase {
  final SupabaseClient _supabase = Supabase.instance.client;

  final String table = "kebakaran";
  ...
  Future insert({required KebakaranModel model}) async {
    try {
  ...
  Future update({required int id, required KebakaranModel model}) async {
    try {
