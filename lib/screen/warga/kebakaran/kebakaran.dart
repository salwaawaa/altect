import 'package:altect/screen/warga/kebakaran/controllers/kebakaran_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:google_fonts/google_fonts.dart';

class Kebakaran extends GetView<KebakaranController> {
  final KebakaranController controller = Get.put(KebakaranController());
  @override
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 0),
                // GetBuilder<KebakaranController>(builder: (_) {
                //   return Center(
                //     child: Padding(
